...
class MyUserRepositoryTest {
    ...
    void findByUsername() {
        ...
        MyUser testePersisted = myUserRepository.save(new MyUser(1L, "teste", "$2a$12$TKiUADI9CXklQ5AlJ2loJe6eUTbyAs9WKp7xMKyB9.Lq4eKYR1gAG", new ArrayList<>(), new ArrayList<>()));
